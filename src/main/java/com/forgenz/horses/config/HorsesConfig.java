...
public class HorsesConfig extends AbstractConfig {
    ...
    public HorsesConfig(final Horses plugin) {
        ...
        final Map<String, HorsesWorldConfig> worldConfigs = new HashMap<>();
        ...
        packCost = new EssentialsItem(Objects.requireNonNull(cfg.getString("HorsePackCost")));
        ...
        if (cfg.contains("SpawnEffects")) {
            spawnEffects = VoxEffects.fromConfig(Objects.requireNonNull(cfg.getConfigurationSection("SpawnEffects")));
        }
        if (cfg.contains("DismissEffects")) {
            dismisEffects = VoxEffects.fromConfig(Objects.requireNonNull(cfg.getConfigurationSection("DismissEffects")));
        }
